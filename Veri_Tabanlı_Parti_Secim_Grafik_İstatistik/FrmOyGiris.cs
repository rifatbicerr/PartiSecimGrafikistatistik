...
namespace Veri_Tabanlı_Parti_Secim_Grafik_İstatistik
{
    public partial class Form1 : Form
    {
        ...
        SqlConnection baglanti=new SqlConnection("Data Source=RIFAT;Initial Catalog=DBSECIMPROJE;Integrated Security=True");
        ...
        private void BtnÇıkısYap_Click(object sender, EventArgs e)
        {
            this.Close();
        }
